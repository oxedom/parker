(function (global, factory) {
	...
	var $indexOf$1 = callBind$3(GetIntrinsic$6('String.prototype.indexOf'));
	...
	var isRegex$1 = hasToStringTag$7
	// eslint-disable-next-line consistent-return
	...
	var isString$3 = function isString(value) {
	  ...
	  return hasToStringTag$5 ? tryStringObject(value) : toStr$5.call(value) === strClass;
	};
	...
	var isNumberObject = function isNumberObject(value) {
	  ...
	  return hasToStringTag$4 ? tryNumberObject(value) : toStr$4.call(value) === numClass;
	};
	...
	var isBooleanObject = function isBoolean(value) {
	  ...
	  return hasToStringTag$3 && Symbol.toStringTag in value ? tryBooleanObject(value) : $toString$2(value) === boolClass;
	};
	...
	var isMap$3 = exported$2 || function isMap(x) {
	  ...
	  try {
	    ...
	    return x instanceof $Map$3; // core-js workaround, pre-v2.5.0
	  } catch (e) {}
	  return false;
	};
	...
	var $WeakSet = GetIntrinsic$4('%WeakSet%', true);
	var $setHas$1 = callBound$6('WeakSet.prototype.has', true);
	if ($setHas$1) {
	  var $mapHas$2 = callBound$6('WeakMap.prototype.has', true);
	...
	if (hasSymbols$4() || shams$1()) {
	  ...
	  var $Map$1 = GetIntrinsic$3('%Map%', true);
	...
	var objectInspect = function inspect_(obj, options, depth, seen) {
	  ...
	  if (!isDate$1(obj) && !isRegExp(obj)) {
	    ...
	    var stringTag = !isPlainObject && toStringTag && Object(obj) === obj && toStringTag in obj ? $slice$2.call(toStr$2(obj), 8, -1) : protoTag ? 'Object' : '';
