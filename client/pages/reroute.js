...
const reroute = () => {
    ...
    return ( <div className="h-screen gap-2 pt-10 flex flex-col   min-h-screen  bg-fixed bg-no-repeat bg-cover  bg-filler w-full grow items-center">
            ...
            <button onClick={(e) => { handleReroute('input')}} className="bg-purple-500 rounded-md text-white text-3xl p-5"> Stream Video</button>
            <button onClick={(e) => { handleReroute('view')}} className="bg-orange-500 rounded-md text-white text-3xl p-5"> View Parking Situation</button>
            </div>
